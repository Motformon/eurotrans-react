...
require_once $_SERVER['DOCUMENT_ROOT']."/projects/eurotrans-react/utils/make_tikets.php";
?>
...
<header class="main-header main-header_booking">
  ...
  <div class="main-header__booking-form">
    <h1 class="main-header__title text text_regular">
      <?= $fromCity ?> — <?= $toCity ?></h1>
    <form class="booking-form booking-form_page-booking" action="/projects/eurotrans-react/booking.php" id="booking-form_page-booking"
